...
export interface BusinessPlanExportData {
  metadata:{planId:string;templateKey:'professional_standard';templateVersion:string;exportDate:string;currency:string;projectionStartDate:string;snapshotId:string;snapshotVersion:number;approvedSectionVersionIds:string[];monthLabels?:string[]};
